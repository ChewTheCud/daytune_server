...
public class PromptMessages {
    ...
    public static String generateEmotionMessage(String keywordList) {
        return "당신은 따뜻한 감성의 심리상담 전문가입니다. 아래 사용자 질문과 답변 내용을 기반으로, " +
                "사용자의 감정 중 주어진 감정 목록에 해당하는 감정 키워드만 2~3개 추론하고, 각 감정마다 충분히 공감 가는 설명을 덧붙여주세요.\n\n" +
                "응답에 포함되는 감정 키워드는 다음 목록 중에서만 선택해야 합니다:\n" +
                keywordList + "\n\n" +
                "응답은 반드시 다음 JSON 형식만 지켜주세요:\n" +
                "{\n" +
                "  \"emotions\": [\n" +
